  ...
  const fetchNews = async () => {
    try {
      ...
      const url = selectedCategory === 'Tous'
        ? `https://tradesense-ai-production-58e6.up.railway.app/api/news`
        : `https://tradesense-ai-production-58e6.up.railway.app/api/news?category=${encodeURIComponent(selectedCategory)}`;
